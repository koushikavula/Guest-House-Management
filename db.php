...
echo '<div class="row">
     ...
     <h2 class="text" style="color:white;">Vasireddy Venkatadri Institute of Technology</h2>
...
mail($to,$subject,$msg,'From:'.$email);
  ...
  echo '<div class="row">
       <div class="col-md-12" style="text-align:center;">
       <img src="images/logo.gif" class="img-fluid" style="height:100px;width:100px;"> <br/>
       <h2 class="text" style="color:white;">Vasireddy Venkatadri Institite of Technology</h2>
       <a href="index.php" style="background:orange;color:white;border-radius:10px;padding:10px;">Main Page</a>
       </div>
       </div>';
  echo '</div>';
